...
export default function Page() {
  return (
    <Card className="p-4">
      ...
      <p className="text-sm">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius incidunt temporibus sunt
        necessitatibus eaque labore error eos nesciunt harum deserunt, dignissimos ratione voluptate
        vel quisquam fugit, veritatis inventore ipsa aspernatur?
      </p>
    </Card>
  )
}
